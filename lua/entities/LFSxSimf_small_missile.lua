...
if SERVER then
	...
	function ENT:FollowTarget( followent )
		...
		local speed = self:GetStartVelocity() + (self:GetDirtyMissile() and 2000 or 4500)
	...
	function ENT:Initialize()	
		...
		self:SetModel( "models/notakid/gtavredux/sharedmodels/veh_t3_missile.mdl" )
	...
	function ENT:Think()	
		...
		if self.Explode then
			...
			util.BlastDamage( IsValid( Inflictor ) and Inflictor or Entity(0), IsValid( Attacker ) and Attacker or Entity(0), self:GetPos(),350,150)
